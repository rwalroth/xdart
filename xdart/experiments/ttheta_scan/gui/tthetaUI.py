...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.middleFrame)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.middleSplitter = QtWidgets.QSplitter(self.middleFrame)
        self.middleSplitter.setOrientation(QtCore.Qt.Vertical)
        self.middleSplitter.setObjectName("middleSplitter")
        self.imageWindow = QtWidgets.QFrame(self.middleSplitter)
        ...
        self.plotWindow = QtWidgets.QFrame(self.middleSplitter)
