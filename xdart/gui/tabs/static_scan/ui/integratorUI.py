...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_5.addWidget(self.all1D)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.all2D.sizePolicy().hasHeightForWidth())
        self.all2D.setSizePolicy(sizePolicy)
        self.all2D.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.all2D.setObjectName("all2D")
        self.horizontalLayout_11.addWidget(self.all2D)
        ...
        self.apply_mask = QtWidgets.QCheckBox(self.frame_3)
        self.apply_mask.setMaximumSize(QtCore.QSize(120, 16777215))
        self.apply_mask.setObjectName("apply_mask")
        self.horizontalLayout_13.addWidget(self.apply_mask)
        ...
        Form.setTabOrder(self.advanced2D, self.all2D)
        Form.setTabOrder(self.all2D, self.pyfai_calib)
        Form.setTabOrder(self.pyfai_calib, self.get_mask)
        Form.setTabOrder(self.get_mask, self.apply_mask)
    ...
    def retranslateUi(self, Form):
        ...
        self.apply_mask.setText(_translate("Form", "Apply Mask"))
