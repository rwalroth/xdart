...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushLeftLast.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.normChannelLabel.setMinimumSize(QtCore.QSize(80, 0))
        self.normChannelLabel.setMaximumSize(QtCore.QSize(82, 16777215))
        ...
        self.normChannel.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.imageUnit.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.shareAxis.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.imageMask.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.update2D.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.setBkg = QtWidgets.QPushButton(self.imageToolbar)
        self.setBkg.setObjectName("setBkg")
        self.horizontalLayout_2.addWidget(self.setBkg)
        spacerItem5 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem5)
        self.cmap = QtWidgets.QComboBox(self.imageToolbar)
        self.cmap.setMinimumSize(QtCore.QSize(75, 0))
        self.cmap.setMaximumSize(QtCore.QSize(80, 16777215))
        self.cmap.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.scale = QtWidgets.QComboBox(self.plotToolBar)
        ...
        self.plotMethod.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.yOffset.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.plotUnit.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.pushRightLast.setFocusPolicy(QtCore.Qt.ClickFocus)
    ...
    def retranslateUi(self, Form):
        ...
        self.normChannel.setItemText(6, _translate("Form", "I2"))
        ...
        self.cmap.setItemText(0, _translate("Form", "viridis"))
        self.cmap.setItemText(1, _translate("Form", "grey"))
        self.cmap.setItemText(2, _translate("Form", "plasma"))
        self.cmap.setItemText(3, _translate("Form", "inferno"))
        self.cmap.setItemText(4, _translate("Form", "magma"))
        self.cmap.setItemText(5, _translate("Form", "thermal"))
        self.cmap.setItemText(6, _translate("Form", "flame"))
        self.cmap.setItemText(7, _translate("Form", "yellowy"))
        self.cmap.setItemText(8, _translate("Form", "bipolar"))
        self.cmap.setItemText(9, _translate("Form", "greyclip"))
        ...
        self.plotMethod.setItemText(2, _translate("Form", "Sum"))
        self.plotMethod.setItemText(3, _translate("Form", "Waterfall"))
