...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.slice_axis.setMinimumSize(QtCore.QSize(50, 0))
        self.slice_axis.setMaximumSize(QtCore.QSize(50, 16777215))
        ...
        self.slice_axis.setBuddy(self.slice_center)
        ...
        Form.setTabOrder(self.imageUnit, self.shareAxis)
        Form.setTabOrder(self.shareAxis, self.update2D)
        Form.setTabOrder(self.update2D, self.save_2D)
        ...
        Form.setTabOrder(self.slice_width, self.slice)
        Form.setTabOrder(self.slice, self.plotMethod)
        Form.setTabOrder(self.plotMethod, self.yOffset)
        Form.setTabOrder(self.yOffset, self.showLegend)
        Form.setTabOrder(self.showLegend, self.save_1D)
