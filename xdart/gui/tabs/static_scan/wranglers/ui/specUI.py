...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.specLabel.setMinimumSize(QtCore.QSize(0, 20))
        self.specLabel.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.commandFrame.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.commandFrame)
